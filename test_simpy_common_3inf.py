...
optimal rerouting of traffic under DOS attack. This is training those routers with atleast 3 network interfaces.
...
from envs.pz_simpy_common_3inf import env
