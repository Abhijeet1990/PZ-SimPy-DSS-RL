...
optimal rerouting of traffic under DOS attack. This is training those routers with atleast 2 network interfaces.
...
from envs.pz_simpy_common_space import env
...
if __name__ == "__main__":
    ...
    model = train(env,steps=1000000)
    eval(env,model,num_games=1000,random=True)
    eval(env,model,num_games=1000,random=False)
