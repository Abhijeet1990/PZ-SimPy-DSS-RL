...
class BaseEnv(AECEnv):
    ...
    def __init__(self,  deviceCount: int, render_mode=None):
        ...
        #simple
        #self.possible_agents = ["R1","R2","R3","R4","R5"]

        # complex
        self.possible_agents = ["R1","R2","R3","R4","R5","R6","R7"]
        #self.possible_agents = ["R2","R3","R4","R5"]
        ...
        #     agent: Box(low=0, high=1000000.0, shape=(self.deviceCount,), dtype=np.float32) for agent in self.possible_agents
        # }
